"""
Django settings for manage_sensors_app project.
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://redis:6379/1",  # o la URL de tu Redis en la nube
        "OPTIONS": {
...
WSGI_APPLICATION = 'manage_sensors_app.wsgi.application'
